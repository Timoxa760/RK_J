...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  scan_parse_failed:
    'Не удалось извлечь условия из PDF. Нужны сумма, ставка (или ПСК) и срок — в договоре кредита, займа или кредита наличными.',
  scan_general_conditions:
    'Это общие условия продукта, а не ваш договор. Загрузите «Индивидуальные условия» или договор займа/кредита с суммой, ставкой и сроком.',
  scan_no_text:
    'В PDF нет текста для распознавания. Нужен текстовый PDF, не фото или скан без OCR.'
}
...
const API_ERROR_TEXT: Record<string, string> = {
  ...
  scan_no_text:
    'В PDF нет текста для распознавания. Нужен текстовый PDF, не фото или скан без OCR.',
  'could not parse contract fields from pdf':
    'Не удалось извлечь условия из PDF. Нужны сумма, ставка (или ПСК) и срок — в договоре кредита, займа или кредита наличными.',
  'pdf required': 'Нужен файл в формате PDF'
}
...
const STATUS_FALLBACKS: Record<number, string> = {
  ...
  422: 'Не удалось распознать договор. Попробуйте другой PDF или более чёткий файл.'
}
